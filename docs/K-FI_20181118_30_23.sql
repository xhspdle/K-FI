...
COMMENT ON COLUMN COMMUNITY.CS_COLOR IS '컬러코드'
/
...
COMMENT ON COLUMN COMM_BOARD.USER_NUM IS '유저번호'
/
...
ALTER TABLE COMM_BOARD
    ADD CONSTRAINT FK_COMM_BOARD_USER_NUM_MEMBERS FOREIGN KEY (USER_NUM)
        REFERENCES MEMBERS (USER_NUM)
/
...
COMMENT ON COLUMN COMM_VOTE.USER_NUM IS '유저번호'
/
...
-- VOTING_USERLIST Table Create SQL
CREATE TABLE VOTING_USERLIST
(
    VU_NUM      NUMBER    NOT NULL, 
    VO_NUM      NUMBER    NULL, 
    USER_NUM    NUMBER    NULL, 
    CONSTRAINT VOTING_USERLIST_PK PRIMARY KEY (VU_NUM)
)
/

COMMENT ON TABLE VOTING_USERLIST IS '투표유저리스트'
/

COMMENT ON COLUMN VOTING_USERLIST.VU_NUM IS '리스트번호'
/

COMMENT ON COLUMN VOTING_USERLIST.VO_NUM IS '투표선택번호'
/

COMMENT ON COLUMN VOTING_USERLIST.USER_NUM IS '유저번호'
/
