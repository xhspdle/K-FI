...
public class AdminBoardListViewVo {
	...
	public AdminBoardListViewVo() {
		super();
		// TODO Auto-generated constructor stub
	}
	public AdminBoardListViewVo(String admin_id, String admin_nick, int ab_num, int admin_num, int ab_notice,
