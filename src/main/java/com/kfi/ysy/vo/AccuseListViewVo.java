...
public class AccuseListViewVo {
	...
	public AccuseListViewVo() {}
	public AccuseListViewVo(int ac_num, int user1_num, int user2_num, String ac_reason, int cb_num, int board_num, Date ac_date,
