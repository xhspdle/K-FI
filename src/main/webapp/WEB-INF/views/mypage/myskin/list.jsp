...
<div class="myskin">
	...
	<div style="margin:auto;background-color: #00cee8;">
		...
		<div class="w3-row-padding w3-margin-top" style="height:370px;">
			<div class="w3-third" style="width: 80%; margin: auto;">
				<div class="w3-card" id="noneCover" style="display:none !important;">
				<div class="pre_cover" id="myskin_list_cover">
					...
					<h4><span id="myskin_list_nickname" >${user_nickname}</span></h4>
   					<span id="myskin_list_msg" style="width: max-content;color:black;border-bottom: 2px solid white;display: block;margin-left: auto;margin-right: auto;margin-top: -25px;"></span>
     			</div>
