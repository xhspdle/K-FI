...
<script type="text/javascript">
 	$(function(){
		$(".abcontent").click(function(event) {
	...
	/* 		$("#wrap").css("opacity", "0.1"); */
			...
			$.getJSON("<c:url value='/abdetail'/>", {
				...
				var board=document.getElementById("abmodifymodal");
				...
				p.innerHTML="멋지네요!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
				img.src="<c:url value='/resources/images/1 ("+i+").jpg'/>";
				board.appendChild(div).appendChild(img);
				div.appendChild(p);	
			});
...
<table class="table table-striped">
	...
	<c:forEach var="ablist" items="${ablist }">
		<tr class="abcontent">
			...
			<td><a href="abdelete?ab_num=${ablist.ab_num}"><i class="glyphicon glyphicon-remove"></i></a></td>
		</tr>
	</c:forEach>	
</table>
<!-- <div class="container">
...
<c:forEach var="i" begin="${apu.startpagenum }" end="${apu.endpagenum }">
	<%-- <a href="<c:url value='/ablist?pagenum=${i }&field=${field }&keyword=${keyword }'/>">
			...
			<ul class="pagination">
			 <li> <a href="<c:url value='/ablist?pagenum=${i }&field=${field }&keyword=${keyword }'/>">
			${i }</a></li> </ul>
