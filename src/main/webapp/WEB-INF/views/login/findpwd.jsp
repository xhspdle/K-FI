...
<div class="container">
 ...
 <div class="col-sm-4">
	<div class="container">
		...
		<form class="navbar-form navbar-left" action="<c:url value='/login/findpwdmail'/>" method="post">
			<div class="form-group">
				<label class="form-control-label" for="ficode">ID</label><br>
				<input type="text" class="form-control" id="ficode" name="user_id"placeholder="Enter ID" value="${user_id}">
	...
	<div class="container">
	<form class="navbar-form navbar-left" action="<c:url value='/login/selectcode'/>" method="post">
			<div class="form-group">
				<label class="form-control-label" for="ficode">Code</label><br>
				<input type="text" class="form-control" id="ficode" name="cm_key"placeholder="Enter Code" value="${cm_key}">
