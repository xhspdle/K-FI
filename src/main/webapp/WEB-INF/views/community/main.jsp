...
<div id="best" class="container text-center">
	<h1 class="bigTitle" style="margin-bottom: 50px;margin-top: 60px;">BEST COMMUNITY</h1>
...
<div id="issue-img" class="container-fluid bg-grey text-center">
	...
	<div class="row">
		<div class="col-sm-4">
			<p><small>2018-11-13</small></p>
			<p>게시글 제목만 보여주면 되지않을까</p>
			<img class="img-responsive margin"
				src="<c:url value='/resources/images/logo2.png'/>" alt="community issue list" style="width:100%">
		</div>
		<div class="col-sm-4">
			<p><small>2018-11-13</small></p>
			<p>blablabla blablabla</p>
			<img class="img-responsive margin"
				src="<c:url value='/resources/images/라이언움짤.gif'/>" alt="community issue list" style="width:100%">
		</div>
		<div class="col-sm-4">
			<p><small>2018-11-13</small></p>
			<p>블라블라블라블라</p>
			<img class="img-responsive margin"
				src="<c:url value='/resources/images/Kpoplogo.png'/>" alt="community issue list" style="width:100%">
		</div>
	</div>
</div>
...
<div id="build" class="container-fluid bg-grey">
	<div class="row">
		<div class="col-sm-offset-2 col-sm-5">
			...
			<p>Custom design features including logo, theme color, background image!</p>
